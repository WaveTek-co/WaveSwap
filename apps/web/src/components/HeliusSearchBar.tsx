      ...
      >
        ...
        <div className="relative z-10">
          <div className="relative">
            <div className="absolute left-2.5 top-1/2 transform -translate-y-1/2 flex items-center justify-center pointer-events-none">
              <img
                src="/orb-logo-orange.svg"
                alt="Helius Orb"
                className="h-4.5 w-4.5 min-w-[18px] min-h-[18px]"
                style={{
                  filter: theme.name === 'dark' ? 'brightness(1.3) saturate(1.2)' : 'brightness(1.1) saturate(1.1)',
                  objectFit: 'contain'
                }}
              />
            </div>
            ...
            <input
              ...
              placeholder="Search..."
              className="w-full pl-10 pr-6 py-1 rounded-md text-xs"
              style={{
                border: `1px solid ${theme.colors.border}`,
            ...
            <button
              onClick={() => setQuery('')}
              className="absolute right-1.5 top-1/2 transform -translate-y-1/2 flex items-center opacity-60 hover:opacity-100 transition-opacity"
            >
